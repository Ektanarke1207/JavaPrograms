...
//The getLogger() method of a Logger class used find or create a logger
		...
		if (title.equals("Google")) {
			System.out.println("Correct tittle is google");
			log.info("Correct tittle is google and test case passed");
		} else {
			System.out.println("not correct tittle ,correct tittle is Google");
			log.info("not correct tittle ,correct tittle is Google and test case failed");
		}
